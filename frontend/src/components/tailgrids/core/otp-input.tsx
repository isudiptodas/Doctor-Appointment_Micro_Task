      ...
      <div className="flex items-center gap-2 not-focus-within:text-neutral-400 focus-within:text-neutral-800">
        {otp.map((digit, index) => (
          <input
            ...
            className={`bg-neutral focus:border-primary-300 focus:ring-primary-100 flex size-11 items-center justify-center rounded-lg border border-black p-2 text-center text-base font-normal shadow-xs focus:ring-3 focus:outline-none disabled:border-neutral-200 disabled:bg-neutral-50 disabled:text-neutral-300`}
            style={{
